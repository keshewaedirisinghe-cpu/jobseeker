...
- [`../patterns/README.md`](../patterns/README.md) defines coding standards and implementation patterns for every milestone.
- [`../prompts/README.md`](../prompts/README.md) indexes fresh-context Codex prompts in execution order.
- Each prompt lists the milestone document, relevant pattern files, supporting references, verification expectations, and completion handoff rules.
